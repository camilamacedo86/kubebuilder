...
const metricsServiceName = "project-v4-with-grafana-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "project-v4-with-grafana-metrics-binding"
