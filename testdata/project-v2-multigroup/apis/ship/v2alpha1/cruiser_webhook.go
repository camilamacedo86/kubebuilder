...
//+kubebuilder:webhook:webhookVersions={v1beta1},verbs=create;update,path=/validate-ship-testproject-org-v2alpha1-cruiser,mutating=false,failurePolicy=fail,groups=ship.testproject.org,resources=cruisers,versions=v2alpha1,name=vcruiser.kb.io,sideEffects=None,admissionReviewVersions={v1beta1}
