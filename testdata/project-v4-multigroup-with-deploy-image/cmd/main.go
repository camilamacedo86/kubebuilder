...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		// More info:
		// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.18.3/pkg/metrics/server
		...
		Metrics: metricsserver.Options{
			...
			// https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.18.3/pkg/metrics/filters#WithAuthenticationAndAuthorization
