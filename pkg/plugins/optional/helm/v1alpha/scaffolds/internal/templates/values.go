...
// Define the content for the values.yaml file
// Define the content for the values.yaml file
const helmValuesTemplate = `# Default values for the Kubebuilder Helm chart
...
# CertManager settings for certificates
certmanager:
  create: false
